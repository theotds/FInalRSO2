...
int main(int argc, char *argv[]) {
    try {
        ...
        auto stop_names = {"3 maja", "Pilsudskiego", "Kilinskiego", "Moniuszki", "Andrespol", "Krakowska"};
